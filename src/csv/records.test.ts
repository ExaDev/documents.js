...
import { CsvParseError, DEFAULT_CSV_DELIMITER, TSV_DELIMITER, parseCsvRecords, quoteCsvField } from './records';
...
describe('quoteCsvField', () => {
  it('writes a field with no delimiter, quote, or line break bare', () => {
    ...
    expect(quoteCsvField('plain,with,commas', TSV_DELIMITER)).toBe('plain,with,commas');
  });
