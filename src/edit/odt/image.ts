...
export function buildImageFrame(href: string, frame: Box, altText?: string): XmlElement {
...
export function insertImageFrameMedia(pkg: Package, frame: Box, image: ImageInit): XmlElement {
