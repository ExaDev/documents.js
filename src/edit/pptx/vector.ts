...
//
// No p:txBody is written. CT_Shape declares it optional (ECMA-376 19.3.1.43), a geometric primitive carries no text, and inventing an empty paragraph for one would make ooxml.js's own readPptx report a text shape where the source had pure geometry.
