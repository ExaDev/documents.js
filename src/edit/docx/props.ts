...
// A toggle property (w:b, w:i, w:strike, w:u's presence form) reflects only this run/paragraph's OWN direct formatting, not the fully style-cascaded effective value -- resolving the cascade is ooxml/docx/styles.ts's job (Step 8), for the conversion pipeline; this editor is a direct- formatting view, matching how the DocxRun/DocxParagraph API is documented.
