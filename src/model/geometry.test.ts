...
import { type Box, flipY } from './geometry';

// Box/Margins/PageSize/PAGE_SIZE_A4/PAGE_SIZE_LETTER/SLIDE_SIZE_STANDARD/SLIDE_SIZE_WIDESCREEN are now pure re-exports from document-content-model, with their own coverage there -- flipY is the one piece of local logic left in this file (PDF-specific, out of document-content-model's scope), so it is the only thing still tested here.
