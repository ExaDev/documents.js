...
async function advanceToFontsField(rendered: ReturnType<typeof render>): Promise<void> {
...
describe('ExportOptionsScreen', () => {
  ...
  it('threads every font path typed into the font field through to the export', async () => {
    ...
    expect(call?.[2].fontFiles).toStrictEqual(['/fonts/Brand-Regular.ttf', '/fonts/Brand Bold.ttf']);
  });
});
