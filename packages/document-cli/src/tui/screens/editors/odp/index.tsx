...
// slide-detail and shape-editor are genuinely shared between pptx and odp (see their own doc comments in ../pptx/) -- re-exported here too so an odp-side caller (the app.tsx screen router) never has to know they physically live under the pptx/ directory.
export { ShapeEditorScreen, SlideDetailScreen } from '../pptx/index.js';
