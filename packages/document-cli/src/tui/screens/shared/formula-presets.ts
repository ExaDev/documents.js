...
function element(tag: string, children: readonly MathMlNode[] = []): MathMlNode {
...
export const FORMULA_PRESETS: readonly FormulaPreset[] = [
  ...
  { label: 'Square root: sqrt(x)', mathml: [element('msqrt', [mi('x')])] },
  {
    ...
    mathml: [element('munderover', [mo('∑'), element('mrow', [mi('i'), mo('='), mn('1')]), mi('n')])],
  },
  {
      ...
      element('mrow', [
        ...
        element('mfrac', [
          element('mrow', [
            ...
            mi('b'),
            mo('±'),
            element('msqrt', [element('mrow', [element('msup', [mi('b'), mn('2')]), mo('-'), mn('4'), mi('a'), mi('c')])]),
          ]),
