...
export const BODY_TEXT = 'A paragraph proving the rest of the document survives.';

export function buildDocxWithMetadata(metadata: LayoutMetadata = METADATA_FIXTURE): Uint8Array<ArrayBuffer> {
...
export function buildPdfWithMetadata(metadata: LayoutMetadata = METADATA_FIXTURE): Uint8Array<ArrayBuffer> {
    ...
    pages: [
      {
        widthPt: 595,
        heightPt: 842,
        items: [{ kind: 'text', text: BODY_TEXT, xPt: 72, yPt: 750, font: { family: 'Helvetica', weight: 'normal', style: 'normal' }, sizePt: 12, color: { r: 0, g: 0, b: 0 } }],
      },
    ],
    images: {},
  };
