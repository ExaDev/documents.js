...
export function dimensionsEqual(
  a: Readonly<DimensionVector>,
  b: Readonly<DimensionVector>,
): boolean {
...
export function isDimensionless(dimension: Readonly<DimensionVector>): boolean {
  return SI_BASE_DIMENSIONS.every(
...
export function dimensionToString(
  dimension: Readonly<DimensionVector>,
): string {
