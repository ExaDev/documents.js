...
async function globalSetup(config: FullConfig) {
  ...
  await page
    .locator('[role="presentation"].mantine-Dropzone-root')
    .waitFor({ timeout: 60_000 });
  await browser.close();
}
