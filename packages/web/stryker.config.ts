...
export default packageStrykerConfig({
  ...
  // Measured after covering the convert route (in addition to metadata, package, editors, .odb, inspect, and .odm): 68.46% of 1633 valid mutants, timeout share 1.10% -- break = floor(score) minus the timeout share rounded up to whole points (minimum one), per the derivation rule on PackageStrykerOptions.breakThreshold.
  breakThreshold: 66,
});
