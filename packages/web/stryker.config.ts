...
export default packageStrykerConfig({
  ...
  // Measured after covering the .odb, inspect, and .odm routes: 47.10% of 1656 valid mutants, timeout share 1.09% -- break = floor(score) minus the timeout share rounded up to whole points (minimum one), per the derivation rule on PackageStrykerOptions.breakThreshold.
  breakThreshold: 45,
});
