...
export default packageStrykerConfig({
  ...
  // Measured after covering the metadata, package, and editors routes on top of the .odb, inspect, and .odm routes: 58.62% of 1658 valid mutants, timeout share 1.09% -- break = floor(score) minus the timeout share rounded up to whole points (minimum one), per the derivation rule on PackageStrykerOptions.breakThreshold.
  breakThreshold: 56,
});
