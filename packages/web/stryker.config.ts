...
export default packageStrykerConfig({
  ...
  // First CI-measured baseline: 40.52% of 1666 valid mutants, timeout share 1.08% -- break = floor(score) minus the timeout share rounded up to whole points (minimum one), per the derivation rule on PackageStrykerOptions.breakThreshold.
  breakThreshold: 38,
});
