...
//
// RTF code page 950: lead byte -> a dense 256-character string indexed by the trail byte (0x00-0xFF), the decoded character for that lead+trail pair, or U+FFFD where the page leaves that pair undefined.

const LEAD_BYTE_MIN = 0x80;
...
export const LEAD_BYTE_TABLE: ReadonlyMap<number, string> = new Map(
  LEAD_BYTE_TRAIL_TABLES.flatMap((table, index) =>
