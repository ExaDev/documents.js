...
//
// RTF code page 936: lead byte -> a dense 256-character string indexed by the trail byte (0x00-0xFF), the decoded character for that lead+trail pair, or U+FFFD where the page leaves that pair undefined.
