...
* **documents.js:** restamp example goldens for document-schema.js@5.0.0 ([2b57732](https://github.com/ExaDev/documents.js/commit/2b57732b020edb77815799dad7f2f2c1dbbe0796))
...
* refactor(docx)!: drop the flat headers/footers arrays from DocxExtras ([c162d52](https://github.com/ExaDev/documents.js/commit/c162d521cc970aca0bc817bd595254db70900591))


### Features

* **docx:** carry the structural header/footer model in DocxExtras ([c3e664d](https://github.com/ExaDev/documents.js/commit/c3e664d28b5dfe73a101af2826217d8c05726baf))
...
* **documents:** drive headings, tables, and divisions from tagged structure ([0d2aa98](https://github.com/ExaDev/documents.js/commit/0d2aa98985754c8ea0b3e46d3a3a54085ecf2b10))
* **documents:** stamp the structure tree as a package definitions tenant ([84193a4](https://github.com/ExaDev/documents.js/commit/84193a456ca24c4ec82af97a9591f3e47fe2e2f2))
...
* **metadata:** read xlsx metadata from the workbook's own docProps, not a rendered PDF preview ([896bd06](https://github.com/ExaDev/documents.js/commit/896bd0654064f31d77e4fcb806abc7a711aa4ccb)), closes [#744](https://github.com/ExaDev/documents.js/issues/744)
...
* **odf:** gate the odt frame lift behind a frames option, with documents.js opting out ([5194956](https://github.com/ExaDev/documents.js/commit/519495604343e1b529958155f23fdc92d714f764))
...
* **edit:** write headingLevel into docx as w:outlineLvl ([19a0424](https://github.com/ExaDev/documents.js/commit/19a04248ccd8f16cce5ce60b088e0c507a364fae))
* **layout:** inferred headings carry headingLevel alongside the Heading styleId ([9916173](https://github.com/ExaDev/documents.js/commit/99161734e1f7664ce247b454c8a7a62dd30a11c9))
* **layout:** omit absent bold/italic run keys instead of writing explicit undefined ([2580f12](https://github.com/ExaDev/documents.js/commit/2580f1240b90bcd716aa713429be717c45a0d5cf))


### Features

* **layout:** infer heading levels from font size in wordprocessing reconstruction ([f28f198](https://github.com/ExaDev/documents.js/commit/f28f198b1b080132696cdb5979a6a0810aeb31f0))
* **layout:** split reconstructed paragraphs at font-size discontinuities ([e43a443](https://github.com/ExaDev/documents.js/commit/e43a443c9196da1cd65efea7113dcde827cb0af1))
* **markdown:** emit an HTML comment marker for pageBreak blocks in markdown output ([ce5a9d2](https://github.com/ExaDev/documents.js/commit/ce5a9d20ce025598c6bc6947b17f42011763ae6b))
* **markdown:** read a page-break marker back as a pageBreak block ([432baa7](https://github.com/ExaDev/documents.js/commit/432baa7ff021cb7d992572d648bb81ad44f2a407))
...
* restore documents.js version baseline to the published 4.0.20 ([986dec9](https://github.com/ExaDev/documents.js/commit/986dec999a7c65ec86d26a491184932d983fe070))
