...
import type { Attribute as OoxmlAttribute, Package as OoxmlPackage, XmlElement as OoxmlXmlElement, XmlNode as OoxmlXmlNode } from 'ooxml.js';
import type { Attribute as OdfAttribute, Package as OdfPackage, XmlElement as OdfXmlElement, XmlNode as OdfXmlNode } from 'odf.js';
...
describe('ooxml.js / odf.js structural compatibility', () => {
  it('XmlElement is mutually assignable between ooxml.js and odf.js', () => {
    const ooxmlToOdf: OdfXmlElement = assertAssignable<OoxmlXmlElement, OdfXmlElement>(
      { type: 'element', tag: 'a', attributes: [], children: [] },
      (value) => value,
    );
    const odfToOoxml: OoxmlXmlElement = assertAssignable<OdfXmlElement, OoxmlXmlElement>(
      { type: 'element', tag: 'a', attributes: [], children: [] },
      (value) => value,
    );
  ...
  it('XmlNode is mutually assignable between ooxml.js and odf.js', () => {
    const ooxmlToOdf: OdfXmlNode = assertAssignable<OoxmlXmlNode, OdfXmlNode>({ type: 'text', value: 'x' }, (value) => value);
    const odfToOoxml: OoxmlXmlNode = assertAssignable<OdfXmlNode, OoxmlXmlNode>({ type: 'text', value: 'x' }, (value) => value);
  ...
  it('Attribute is mutually assignable between ooxml.js and odf.js', () => {
    const ooxmlToOdf: OdfAttribute = assertAssignable<OoxmlAttribute, OdfAttribute>({ name: 'id', value: '1' }, (value) => value);
    const odfToOoxml: OoxmlAttribute = assertAssignable<OdfAttribute, OoxmlAttribute>({ name: 'id', value: '1' }, (value) => value);
  ...
  it('Package is mutually assignable between ooxml.js and odf.js', () => {
    const ooxmlToOdf: OdfPackage = assertAssignable<OoxmlPackage, OdfPackage>({ parts: {} }, (value) => value);
    const odfToOoxml: OoxmlPackage = assertAssignable<OdfPackage, OoxmlPackage>({ parts: {} }, (value) => value);
