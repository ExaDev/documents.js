...
export function buildDrawingBlock(
  ...
  return {
    ...
    objectKind: "drawing",
    document,
    frame: { xPt: 0, yPt: 0, widthPt: size.widthPt, heightPt: size.heightPt },
  };
}
...
export function drawingOfBlock(
  block: ContentEmbeddedObjectBlock,
): Extract<ContentDocument, { kind: "drawing" }> | undefined {
...
export function embeddedDrawingVectors(
  block: ContentEmbeddedObjectBlock,
  containerOriginPt: ContentPathPoint,
): ContentVector[] {
