...
function fontSubstitutionDiagnostic(
...
export function createLocalDocumentConverter(): DocumentConverter {
  return {
    ...
    async convert(
      ...
      let documentPackage: DocumentTree | undefined;
      ...
      if (source.format === "odf" && targetFormat === "pdf") {
        ...
        return Promise.resolve({
          document: { format: targetFormat, bytes },
          diagnostics,
