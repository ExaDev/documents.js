...
function allFourEdges(style: ContentStrokeStyle) {
  return {
    top: { color: BLACK, widthPt: BORDER_WIDTH_PT, style },
    right: { color: BLACK, widthPt: BORDER_WIDTH_PT, style },
    bottom: { color: BLACK, widthPt: BORDER_WIDTH_PT, style },
    left: { color: BLACK, widthPt: BORDER_WIDTH_PT, style },
  };
}
