...
import { executeBridge, executeFromPdf, FORMAT_NODES, isTextFormatNode, LAYOUT_CAPABLE, resolveCompositionPlan, runCompositionPlan, type ContentFormat, type UnifiedConversionOptions } from './composition';
...
export function executeToPdf(format: ContentFormat, bytes: Uint8Array<ArrayBuffer>, options?: UnifiedConversionOptions): Uint8Array<ArrayBuffer> {
...
export function convertDocument(source: DocumentFormat, target: DocumentFormat, bytes: Uint8Array<ArrayBuffer>, options?: UnifiedConversionOptions): Uint8Array<ArrayBuffer> {
  ...
  return runCompositionPlan(plan, bytes, options, { bridge: executeBridge, fromPdf: executeFromPdf, toPdf: executeToPdf });
}
