...
export const VARIANT_RUN_PROPERTIES: Record<MathVariant, { readonly scr?: string; readonly sty: string }> = {
  normal: { sty: 'p' },
  bold: { sty: 'b' },
  italic: { sty: 'i' },
  'bold-italic': { sty: 'bi' },
...
export function variantFromRunProperties(script: string | undefined, style: string | undefined): MathVariant | undefined {
