...
// Detects an image's container format from its magic bytes, never from a file extension or a caller-supplied label -- both directions of this package's image handling (PDF write/read, OOXML media parts) need to trust the bytes themselves.
