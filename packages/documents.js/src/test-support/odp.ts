...
function buildFixturePackage(): Package {
  ...
  const groupShapeA = el(
    ...
    [el("draw:text-box", {}, [el("text:p", {}, [txt("Grouped A")])])],
  );
  const groupShapeB = el(
    ...
    [el("draw:text-box", {}, [el("text:p", {}, [txt("Grouped B")])])],
  );
  ...
  const notes = el("presentation:notes", {}, [
    el(
      ...
      [
        el("draw:text-box", {}, [
          el("text:p", {}, [txt("Speaker notes for slide one.")]),
        ]),
      ],
    ),
  ]);
  ...
  const table = el("table:table", {}, [
    ...
    el("table:table-column"),
    el("table:table-row", {}, [
      el("table:table-cell", {}, [el("text:p", {}, [txt("A1")])]),
      el("table:table-cell", {}, [el("text:p", {}, [txt("B1")])]),
    ]),
  ]);
  const tableFrame = el(
    "draw:frame",
  ...
  return {
    parts: {
      mimetype: {
        kind: "binary",
        base64: bytesToBase64(enc(ODF_MEDIA_TYPES.odp)),
      },
