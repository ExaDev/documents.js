...
// A minimal but structurally authentic docx package: one paragraph, one 2x1 table, and a styles part with a docDefaults -> Normal -> Heading1 basedOn chain (enough to exercise the style cascade).
