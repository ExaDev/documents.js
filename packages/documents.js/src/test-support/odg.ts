  ...
  return {
    ...
    nodes: [
      el('office:document-styles', {}, [
        el('office:automatic-styles', {}, [el('style:page-layout', { 'style:name': 'PM1' }, [el('style:page-layout-properties', { 'fo:page-width': '400pt', 'fo:page-height': '300pt' })])]),
...
function buildFixturePackage(): Package {
  const rectBack = el('draw:rect', { 'draw:name': 'Back', 'draw:style-name': 'grBack', 'svg:width': '120pt', 'svg:height': '80pt', 'svg:x': '20pt', 'svg:y': '120pt' }, [el('text:p')]);
  const rectFront = el('draw:rect', { 'draw:name': 'Front', 'draw:style-name': 'grFront', 'svg:width': '120pt', 'svg:height': '80pt', 'svg:x': '60pt', 'svg:y': '140pt' }, [el('text:p')]);
  const rect = el('draw:rect', { 'draw:name': 'Rect1', 'draw:style-name': 'grRect', 'svg:width': '100pt', 'svg:height': '70pt', 'svg:x': '20pt', 'svg:y': '20pt' }, [el('text:p')]);
  const ellipse = el('draw:ellipse', { 'draw:name': 'Ellipse1', 'draw:style-name': 'grEllipse', 'svg:width': '100pt', 'svg:height': '70pt', 'svg:x': '160pt', 'svg:y': '20pt' }, [el('text:p')]);
  const line = el('draw:line', { 'draw:name': 'Line1', 'draw:style-name': 'grLine', 'svg:x1': '300pt', 'svg:y1': '20pt', 'svg:x2': '380pt', 'svg:y2': '90pt' }, [el('text:p')]);
  const curvePath = el('draw:path', {
    'draw:name': 'CurvePath1', 'draw:style-name': 'grCurve',
    'svg:width': '3.656cm', 'svg:height': '3.999cm', 'svg:x': '300pt', 'svg:y': '140pt',
    'svg:viewBox': '0 0 3657 4000', 'svg:d': 'M0 4000h3000c1000 0 1000-4000-1000-4000z',
  }, [el('text:p')]);
  const frame = el('draw:frame', { 'draw:name': 'TextFrame', 'svg:x': '305pt', 'svg:y': '160pt', 'svg:width': '80pt', 'svg:height': '30pt' }, [el('draw:text-box', {}, [el('text:p', {}, [txt('Label')])])]);
  const page1 = el('draw:page', { 'draw:name': 'page1', 'draw:master-page-name': 'Default' }, [rectBack, rectFront, rect, ellipse, line, curvePath, frame]);
    ...
    nodes: [
      el('office:document-content', {}, [
        el('office:automatic-styles', {}, [
          graphicStyle('grBack', { 'draw:fill-color': '#ff8000', 'draw:stroke': 'none' }),
          graphicStyle('grFront', { 'draw:fill-color': '#8000ff', 'draw:stroke': 'none' }),
          graphicStyle('grRect', { 'draw:fill-color': '#ff0000', 'svg:stroke-color': '#000000', 'svg:stroke-width': '0.05cm' }),
          graphicStyle('grEllipse', { 'draw:fill-color': '#00c800', 'svg:stroke-color': '#000000', 'svg:stroke-width': '0.03cm' }),
          graphicStyle('grLine', { 'svg:stroke-color': '#0000ff', 'svg:stroke-width': '0.06cm' }),
          graphicStyle('grCurve', { 'draw:fill-color': '#ffff00', 'svg:stroke-color': '#000000', 'svg:stroke-width': '0.05cm' }),
        ]),
  ...
  return {
    parts: {
      mimetype: { kind: 'binary', base64: bytesToBase64(enc(ODF_MEDIA_TYPES.odg)) },
