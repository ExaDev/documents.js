...
export function placeChild(child: MathBox, dxPt: number, baselineOffsetPt: number, overallAscentPt: number): readonly MathLayoutItem[] {
...
export function concatBoxesHorizontally(boxes: readonly MathBox[], gapsPt: readonly number[] = []): MathBox {
  ...
  return { widthPt: cursorXPt, ascentPt, descentPt, heightPt: ascentPt + descentPt, items };
}
