...
function binary(): OperatorProperties {
  return { ...DEFAULT_OPERATOR, lspaceEm: MEDIUM_SPACE, rspaceEm: MEDIUM_SPACE };
}
...
function fence(isOpen: boolean): OperatorProperties {
  return { ...DEFAULT_OPERATOR, lspaceEm: isOpen ? ZERO_SPACE : THIN_SPACE, rspaceEm: isOpen ? THIN_SPACE : ZERO_SPACE, stretchy: true, fence: true };
}

function separator(): OperatorProperties {
  return { ...DEFAULT_OPERATOR, lspaceEm: ZERO_SPACE, rspaceEm: THIN_SPACE, separator: true };
}
...
function bigOperatorFixed(): OperatorProperties {
  return { ...DEFAULT_OPERATOR, lspaceEm: THIN_SPACE, rspaceEm: THIN_SPACE, largeop: true, movablelimits: false, stretchy: false };
}
