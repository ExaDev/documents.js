...
function ensureRelationshipsRootAtPath(pkg: Package, relsPath: string): XmlElement {
...
function addRelationshipAtPath(pkg: Package, relsPath: string, rel: NewRelationship): string {
...
export function addRootRelationship(pkg: Package, rel: NewRelationship): string {
