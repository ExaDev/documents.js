...
export function readCsvContent(
  ...
  const columns: ContentSheetColumn[] = Array.from(
    { length: columnCount },
    (_unused, index) => ({ index, widthPt: COLUMN_WIDTH_PT }),
  );
