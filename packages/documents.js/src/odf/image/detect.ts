...
function readImageFrame(
  frame: XmlElement,
  groupFunctions: readonly OdfTransformFunction[],
  pkg: Package,
  allowFlowAnchored: boolean,
): DetectedImageFrame | undefined {
...
function walkForImageFrames(
  nodes: readonly XmlNode[],
  groupFunctions: readonly OdfTransformFunction[],
  pkg: Package,
  out: DetectedImageFrame[],
): void {
...
export function collectImageFrames(
  nodes: readonly XmlNode[],
  pkg: Package,
): readonly DetectedImageFrame[] {
