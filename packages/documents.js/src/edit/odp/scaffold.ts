...
const STYLES_NS_PREFIXES = ['office', 'style', 'text', 'table', 'draw', 'presentation', 'fo', 'svg', 'xlink'] as const;
...
function buildPageLayout(): XmlElement {
  return el('style:page-layout', { 'style:name': PAGE_LAYOUT_NAME }, [
    el('style:page-layout-properties', { 'fo:page-width': `${SLIDE_SIZE_WIDESCREEN.widthPt}pt`, 'fo:page-height': `${SLIDE_SIZE_WIDESCREEN.heightPt}pt` }),
  ]);
}
