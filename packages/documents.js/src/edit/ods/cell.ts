...
export class OdsCell {
  ...
  //
  // Reads across every text:p child and joins them with '\n', mirroring odf.js's own readCellText (typed/ods/read.ts) -- a cell with multiple text:p children (a real Calc Alt+Enter line break) reads back as a single multi-line string here exactly as it does through readOds itself.
