...
export function buildOdtPackage(
  ...
  options?: BuildOdtPackageOptions,
): Package {
  if (content.kind !== "wordprocessing") {
    throw new Error(
      "buildOdtPackage requires a wordprocessing ContentDocument",
    );
  }
...
function appendMergedImageParagraph(
  body: OdtBody,
...
export function populateParagraph(
