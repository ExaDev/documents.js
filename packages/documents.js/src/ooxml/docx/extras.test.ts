...
describe("readDocxExtras", () => {
  it("reads a comment, its author, and its text from word/comments.xml", () => {
    ...
    expect(extras.comments[0]).toEqual({
      id: "0",
      author: "Jane Doe",
  ...
  it("reads a real footnote from word/footnotes.xml, excluding the separator/continuationSeparator pair", () => {
    ...
    expect(extras.footnotes[0]).toEqual({
      id: "1",
    ...
    expect(extras.headerFooterParts).toEqual([
      {
        ...
        blocks: [
          {
            kind: "paragraph",
            runs: [{ text: "Footer text", fontFamily: "Calibri", sizePt: 11 }],
          },
        ],
      },
      {
        ...
        blocks: [
          {
            kind: "paragraph",
            runs: [{ text: "Header text", fontFamily: "Calibri", sizePt: 11 }],
          },
        ],
      },
    ]);
