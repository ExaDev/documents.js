// Byte-level fidelity of syntheticPresentation, first half: record versions and instances, the blip store, and the drawing properties a table group carries. The slide and notes container cases are in presentation-drawing.test.ts; the record-resolving helpers both halves use are in presentation-records.ts.
