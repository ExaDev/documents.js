...
// Every dump row is sixteen bytes, one hex-dump line's worth.
const HEADER_ROW_SIZE = 16;

// The dump's non-zero rows from the index area on, in document order: the index area's own start is row 0 of this second run, and every later row is the area's own start plus that row's 0-based position times the row size, so no offset here is a restated independent literal.
const INDEX_AREA_ROWS: readonly string[] = [
  "02 00 05 00 00 00 00 00 00 00 00 00 00 00 00 55",
  "01 00 00 00 4E 00 00 00 46 02 00 00 09 25 01 00",
  "00 00 06 00 00 00 94 02 00 00 0B 30 02 00 00 00",
  "28 00 00 00 9A 02 00 00 08 5E 01 00 00 00 0C 00",
  "00 00 C2 02 00 00 28 00 D6 1E C3 0F 39 08 00 00",
  "11 09 00 00 00 5A 00 1B 01 00 8B 14 36 00 54 00",
  "69 00 6D 00 65 00 73 00 20 00 4E 00 65 00 77 00",
  "20 00 52 00 6F 00 6D 00 61 00 6E 00 20 00 52 00",
  "65 00 67 00 75 00 6C 00 61 00 72 00 00 00 00 00",
  "00 00 00 00 01 00 01 00 58 02 01 00 00 00 04 00",
  "28 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00",
  "00 00 00 00 01 12 02 00 24 00 A1 00 00 00 A1 00",
  "00 00 50 A5 4E 25 00 00 00 00 00 00 08 00 DD 0A",
...
const GENERIC_HEADER_LINES: readonly (readonly [number, string])[] = [
  ...
  [HEADER_ROW_SIZE, "05 00 00 00 E9 02 00 00 00 00 00 00 00 00 00 00"],
  ...INDEX_AREA_ROWS.map((line, index): readonly [number, string] => [
    GENERIC_HEADER_INDEX_AREA_OFFSET + index * HEADER_ROW_SIZE,
    line,
  ]),
];
