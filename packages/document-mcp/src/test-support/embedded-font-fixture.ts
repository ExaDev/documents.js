...
export function buildOdtWithEmbeddedFont(options: EmbeddedFontFixtureOptions): Uint8Array<ArrayBuffer> {
  ...
  pkg.parts['Fonts/font1.ttf'] = { kind: 'binary', base64: bytesToBase64(options.fontBytes) };
  ...
  root.children.unshift(
    el('office:font-face-decls', {}, [
      el('style:font-face', { 'style:name': options.family, 'svg:font-family': options.family }, [
        el('svg:font-face-src', {}, [el('svg:font-face-uri', { 'xlink:href': 'Fonts/font1.ttf', 'xlink:type': 'simple' })]),
      ]),
    ]),
  );
