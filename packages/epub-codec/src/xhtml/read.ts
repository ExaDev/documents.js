  ...
  state.context.sink({
    ...
    message:
      previousItem === undefined
        ? `content sits directly inside a <${tag}> before its first <li> (not valid HTML5); recovered as ordinary content immediately before the list, with no list membership of its own`
