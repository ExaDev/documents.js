## [5.2.29](https://github.com/ExaDev/documents.js/compare/pdf-codec%405.2.28...pdf-codec%405.2.29) (2026-09-25)
...
## [5.2.28](https://github.com/ExaDev/documents.js/compare/pdf-codec%405.2.27...pdf-codec%405.2.28) (2026-09-25)

### Code Refactoring

* **pdf-codec:** enable magicNumbers ahead of naming every site ([75b3ae9](https://github.com/ExaDev/documents.js/commit/75b3ae9978af52a65156f59e93fba6c64d94cfec)), references [#1275](https://github.com/ExaDev/documents.js/issues/1275)
* **pdf-codec:** generate the WinAnsi identity ranges instead of listing them ([4f244d0](https://github.com/ExaDev/documents.js/commit/4f244d0fa4df5bd02b88244b578bdf96c6bea9c7))
* **pdf-codec:** name byte-split and BOM constants in math-content-write.ts ([afcf83b](https://github.com/ExaDev/documents.js/commit/afcf83b8a82f0c1dc9e137bd8425c1f6b8a70e7b))
* **pdf-codec:** name byte-split constants in embedded-font.ts ([4863f18](https://github.com/ExaDev/documents.js/commit/4863f18f08940cfef59b617d6f900baad213b4a4))
* **pdf-codec:** name byte-width constant in test-support/jpeg2000.ts ([332fbfc](https://github.com/ExaDev/documents.js/commit/332fbfcbabc05bb72cd033fd4ca5863a56d58d93))
* **pdf-codec:** name CCITT Group 4 encoder byte/bit constants ([e19166a](https://github.com/ExaDev/documents.js/commit/e19166a6d5aa1ddfb9fd6ab2b8ccd3fd7d99fede))
* **pdf-codec:** name ccitt-fax.ts's per-fixture pattern parameters ([d5ecb4c](https://github.com/ExaDev/documents.js/commit/d5ecb4ccf6f27da2aabc0652a9479f5314f58d72))
* **pdf-codec:** name CFF fixture-builder DICT/charstring constants ([13c43a1](https://github.com/ExaDev/documents.js/commit/13c43a147077c5ded88257f447f09d2163f81313))
* **pdf-codec:** name cff.ts's INDEX and DICT operand constants ([c191fbd](https://github.com/ExaDev/documents.js/commit/c191fbded6b391543ca797ba36294ec4b78171dc))
* **pdf-codec:** name composite glyph flag bits in glyf-contours.ts ([4900295](https://github.com/ExaDev/documents.js/commit/4900295ddaab0e036b25d896a580b0ee13d60b28))
* **pdf-codec:** name CR/LF byte constants in parse.ts ([70fff54](https://github.com/ExaDev/documents.js/commit/70fff54c3b3e3595610756cf807515f8e54a160d))
* **pdf-codec:** name encrypt-write.ts's permission bits and Algorithm 10 block layout ([0af4a0c](https://github.com/ExaDev/documents.js/commit/0af4a0c52e6fd6364adeb6595079664a663614c2))
* **pdf-codec:** name encrypt.ts's algorithm constants and derive its fixed byte strings ([a809485](https://github.com/ExaDev/documents.js/commit/a80948582241a5d6ee2ba807443a0a2c73fd72b5))
* **pdf-codec:** name every constant in the LZW, ASCII85, ASCIIHex, and RunLength filters ([bd086c9](https://github.com/ExaDev/documents.js/commit/bd086c9acc61d29a5e60dcbfbd336d3f97d47804))
* **pdf-codec:** name every field byte-offset in the GPOS table parser ([4af8dfd](https://github.com/ExaDev/documents.js/commit/4af8dfd7db43a91e8039e8f0aa26b632d7e02c1e))
* **pdf-codec:** name every marker-segment field in the JPEG 2000 codestream parser ([4928342](https://github.com/ExaDev/documents.js/commit/49283426221ce75138500b3832961a077bbf617f))
* **pdf-codec:** name every remaining CCITT constant and label the Huffman run-length tables ([e509d7b](https://github.com/ExaDev/documents.js/commit/e509d7bdd750915867c7a391629f288626c2dfb8))
* **pdf-codec:** name FIPS 180-4 SHA-2 round constants and rotation amounts ([8092185](https://github.com/ExaDev/documents.js/commit/80921855afe89097b6166a9f42d8f705ba378c92))
* **pdf-codec:** name gdef-table.ts's header field offsets ([8424e43](https://github.com/ExaDev/documents.js/commit/8424e432411284c0adb14a139ebd69ec11f6b45a))
* **pdf-codec:** name hmtx-table.ts's field offset and record size ([826d937](https://github.com/ExaDev/documents.js/commit/826d9371c4f221dae73cc526a52f8d2e71f7b480))
* **pdf-codec:** name jbig2-text.ts's context-bits type-safety fallbacks ([3a78f78](https://github.com/ExaDev/documents.js/commit/3a78f78daacd99970cacfb679b29c6e685dae3dc))
* **pdf-codec:** name jbig2.ts's segment header and region flag fields ([b7f917f](https://github.com/ExaDev/documents.js/commit/b7f917feaca82c5717fd0b3e4548c12cffe1d903))
* **pdf-codec:** name JPEG 2000 Tier-1 entropy coder constants ([f3414d8](https://github.com/ExaDev/documents.js/commit/f3414d8d471601c8c11d175612a38fddfac8d344))
* **pdf-codec:** name jpeg-info.ts's marker codes and segment field offsets ([9c36b16](https://github.com/ExaDev/documents.js/commit/9c36b1636bb5f32d1ca16530ce7dd6a7314ec7ff))
* **pdf-codec:** name lexer.ts's delimiter, escape, and digit-range bytes ([e4ad885](https://github.com/ExaDev/documents.js/commit/e4ad885d1f65fa221cdd452e7ddc5956f7a68936))
* **pdf-codec:** name magic numbers in aes.ts ([a05f338](https://github.com/ExaDev/documents.js/commit/a05f3387973d65ddf31604a2a4d58374da79b544))
* **pdf-codec:** name magic numbers in afm-widths.ts ([9727713](https://github.com/ExaDev/documents.js/commit/97277134032c78b3551b9ad68f12c71730bf548e))
* **pdf-codec:** name magic numbers in annotations.ts and tounicode.ts ([dfc1f73](https://github.com/ExaDev/documents.js/commit/dfc1f738d13ae88e72481fac0361ced15ca7f1ef))
* **pdf-codec:** name magic numbers in builtin-encoding.ts ([75f7ba5](https://github.com/ExaDev/documents.js/commit/75f7ba5b9f7bde3b2d27fafadcbc3542243895c1))
* **pdf-codec:** name magic numbers in bytes/crc32.ts ([88cfab3](https://github.com/ExaDev/documents.js/commit/88cfab392ae9f9ad224d237dea88c52d8bdaedbd))
* **pdf-codec:** name magic numbers in cmap-table.ts ([f132aad](https://github.com/ExaDev/documents.js/commit/f132aaded2e0e55e564c1fb523b41fb591110b6e))
* **pdf-codec:** name magic numbers in crypto/rc4.ts ([744a30f](https://github.com/ExaDev/documents.js/commit/744a30fda547dd2a9bb2ec6df9d10776d029dcf4))
* **pdf-codec:** name magic numbers in encoding.ts ([a8a6f5e](https://github.com/ExaDev/documents.js/commit/a8a6f5e4954d52ad5fee6951489eb644daa88d21))
* **pdf-codec:** name magic numbers in font-face.ts ([c865421](https://github.com/ExaDev/documents.js/commit/c865421e059cfa86d1cc3b70f3965c77f8efbe43))
* **pdf-codec:** name magic numbers in font-read.ts ([94c50b3](https://github.com/ExaDev/documents.js/commit/94c50b342ae7b70f1fa4d96e9332b95ae97f647e))
* **pdf-codec:** name magic numbers in gsub-table.ts ([0299a98](https://github.com/ExaDev/documents.js/commit/0299a9889b78b8007b65110be4e22e3825f32e33))
* **pdf-codec:** name magic numbers in image/jp2-boxes.ts ([577f13d](https://github.com/ExaDev/documents.js/commit/577f13d1828e5e3eeb4bf8190953096a069d286f))
* **pdf-codec:** name magic numbers in images-read.ts ([f2dfb50](https://github.com/ExaDev/documents.js/commit/f2dfb50cdb4f722fba3964ac0fe15e0726b4beed))
* **pdf-codec:** name magic numbers in jbig2-arith.ts ([5747cf0](https://github.com/ExaDev/documents.js/commit/5747cf04b31b0cc928357907da8f0b083eb27fd2)), references [#1275](https://github.com/ExaDev/documents.js/issues/1275)
* **pdf-codec:** name magic numbers in jbig2-bitmap.ts ([a7eb725](https://github.com/ExaDev/documents.js/commit/a7eb725bcdbd29de32718d83db1c6c5bf065d2d8))
* **pdf-codec:** name magic numbers in jbig2-generic.ts ([f429cf3](https://github.com/ExaDev/documents.js/commit/f429cf3a139efdaa05fc1f9f5788e7072d50269e))
* **pdf-codec:** name magic numbers in math-font-write.ts and matrix.ts ([0a2532b](https://github.com/ExaDev/documents.js/commit/0a2532b7e59838ccc900355d0a0ffcbf3493c6ba))
* **pdf-codec:** name magic numbers in math-table.ts ([f3c799b](https://github.com/ExaDev/documents.js/commit/f3c799b553470864455fa19c8de6a68158ae9d58))
* **pdf-codec:** name magic numbers in md5.ts ([ebd8153](https://github.com/ExaDev/documents.js/commit/ebd81535e0f22277758e942482cfb8873cdb7517))
* **pdf-codec:** name magic numbers in navigation.ts ([b34c010](https://github.com/ExaDev/documents.js/commit/b34c0108bb0eccf75ea5b3ab79caae7e80338959))
* **pdf-codec:** name magic numbers in predictors.ts ([b9be6f1](https://github.com/ExaDev/documents.js/commit/b9be6f1c5ffcf06efb130f4d9c43e550c3585eb8))
* **pdf-codec:** name magic numbers in serialize.ts ([27794fb](https://github.com/ExaDev/documents.js/commit/27794fb3f278762be5d36dc17ce8973c898654e1))
* **pdf-codec:** name magic numbers in sfnt-subset.ts ([78da1b4](https://github.com/ExaDev/documents.js/commit/78da1b486601a73413a42a001cce08be6121fb37))
* **pdf-codec:** name magic numbers in sfnt.ts ([2783a65](https://github.com/ExaDev/documents.js/commit/2783a6570a43f6fa1d9086f3873bcf075161cada))
* **pdf-codec:** name math-font.ts's sfnt field offsets and glyph-space scale ([0b815fe](https://github.com/ExaDev/documents.js/commit/0b815fefdf2deaa2f2f41692322258dace22c7c5))
* **pdf-codec:** name page-rotation degrees, the content-stream join byte, and hex radix ([1900fec](https://github.com/ExaDev/documents.js/commit/1900fec7ebe96c5faadec8cb7dabcfa0200e286d))
* **pdf-codec:** name PDF content-stream operator operand indices ([355f0d8](https://github.com/ExaDev/documents.js/commit/355f0d8078cff384de35f391679d59801a86a9ae))
* **pdf-codec:** name PDF header signature bytes in codec.ts ([93a30a5](https://github.com/ExaDev/documents.js/commit/93a30a571ab244ec630bfdf18f2ccbf1d3a30c75))
* **pdf-codec:** name PNG's five filter types and the signed-byte scoring constants ([f74b8ae](https://github.com/ExaDev/documents.js/commit/f74b8ae04abdd5d09823cef49cd7cccb3602861f))
* **pdf-codec:** name SFNT/OpenType fixture-builder byte offsets ([6095e02](https://github.com/ExaDev/documents.js/commit/6095e020bbee636de91be2b5b566466294b2d705))
* **pdf-codec:** name test-support/pdf.ts's fixture object numbers and byte constants ([f86c901](https://github.com/ExaDev/documents.js/commit/f86c901f9f3ede6d81ec449412ed156fbde415d1))
* **pdf-codec:** name text-group.ts's baseline and word-gap fraction denominators ([0311f56](https://github.com/ExaDev/documents.js/commit/0311f566ecf2640efefa20cea9ec4ac7a7946e43))
* **pdf-codec:** name the 5-3 filter's rounding divisor in jpeg2000-dwt ([88990b2](https://github.com/ExaDev/documents.js/commit/88990b2e837245f59cd438ef3dc4c22d09195201))
* **pdf-codec:** name the byte radix and bit-shift used by the CMap reader ([a9fa0de](https://github.com/ExaDev/documents.js/commit/a9fa0dea1872608bc0e00493b245205a2de295f1))
* **pdf-codec:** name the codestream decoder's spec constants in jpeg2000 ([3a1e35e](https://github.com/ExaDev/documents.js/commit/3a1e35e883c10b428fe7d78e1c6f1e6c4f049d93))
* **pdf-codec:** name the composite-glyph and header field offsets in glyf ([697032b](https://github.com/ExaDev/documents.js/commit/697032b4241b314ab0a36092042bdff5354466af))
* **pdf-codec:** name the delimiter bytes and radices in xref ([ae678d2](https://github.com/ExaDev/documents.js/commit/ae678d216e623e30e35b49db4c0bd56591b7282c))
* **pdf-codec:** name the inflate output ceiling in flate.ts ([34b41f9](https://github.com/ExaDev/documents.js/commit/34b41f9376a7a240c9085c50b794cc3bb2e521f5))
* **pdf-codec:** name the PNG signature, chunk layout, IHDR, and colour-type constants ([6990d33](https://github.com/ExaDev/documents.js/commit/6990d333c0b0a589e1711357d4031b494ecfa7e9))
* **pdf-codec:** name the rasteriser's geometry and layout constants in raster ([5938cc9](https://github.com/ExaDev/documents.js/commit/5938cc9e3c7b6cc2a22c6e5bfa0f8f7107007848))
* **pdf-codec:** name the sfnt table field offsets in font-tables ([9d54fbe](https://github.com/ExaDev/documents.js/commit/9d54fbe882aeb0ac2f05c5cb945c1115849f6a45))
* **pdf-codec:** name the shared range-record and ClassDef field offsets ([87992b1](https://github.com/ExaDev/documents.js/commit/87992b160deec844d70916bbebca0fe771df0417))
* **pdf-codec:** name the six ASCII whitespace byte values ([4348d5d](https://github.com/ExaDev/documents.js/commit/4348d5d968b6e12b7bbb7d5fd7477c7747b4c100))
* **pdf-codec:** name the stuffed-bit reader's constants in jpeg2000-tagtree ([f0d9317](https://github.com/ExaDev/documents.js/commit/f0d9317c2b20dfcfae85f105cdb87055fb730b53))
* **pdf-codec:** name the subband count and Table B.4 coding-pass prefix code ([2888fda](https://github.com/ExaDev/documents.js/commit/2888fdaaa51a8c8211b6933bcef255b7027bf7df))
* **pdf-codec:** name the Tz percentage conversion factor in content-write ([b8848a3](https://github.com/ExaDev/documents.js/commit/b8848a3b9851192aa74643bf27026927d6ac3da7))
* **pdf-codec:** name the UTF-16BE BOM bytes and shift width in pdf-text.ts ([b956ea5](https://github.com/ExaDev/documents.js/commit/b956ea5ec28cdcb4a822c1b7887ccdc04867dea3))
* **pdf-codec:** name the xref offset field width in write-pdf-fixture ([b69fd1d](https://github.com/ExaDev/documents.js/commit/b69fd1d4d93d6b787bc435d057eaf414d6c26d7a))
* **pdf-codec:** name Type 2 charstring interpreter constants ([ec23a2b](https://github.com/ExaDev/documents.js/commit/ec23a2b2991f44d836f25f6164e88fbc33713611))
* **pdf-codec:** name write.ts's byte-packing and xref record constants ([3d76cd1](https://github.com/ExaDev/documents.js/commit/3d76cd13a6f86e40892ca7b169cfb65b17a358cb))
...
## [5.2.24](https://github.com/ExaDev/documents.js/compare/pdf-codec%405.2.23...pdf-codec%405.2.24) (2026-09-24)
...
## [5.2.23](https://github.com/ExaDev/documents.js/compare/pdf-codec%405.2.22...pdf-codec%405.2.23) (2026-09-24)
