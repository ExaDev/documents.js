...
// Horizontal reading direction, at whichever of the several scopes a format states it independently (run, paragraph, table row, whole document) -- absent means the format's own default (left-to-right) rather than a stored default, matching this package's convention elsewhere for optional enum fields.
...
export const DEFAULT_LAYOUT_FONT: LayoutFont = {
  family: "Helvetica",
  weight: "normal",
  style: "normal",
};
