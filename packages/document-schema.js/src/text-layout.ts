...
export interface TextMeasurer {
  readonly widthOfTextAtSize: (
    text: string,
    font: Readonly<LayoutFont>,
    sizePt: number,
  ) => number;
  readonly lineHeightAtSize: (
    font: Readonly<LayoutFont>,
    sizePt: number,
  ) => number;
  readonly ascenderAtSize: (
    font: Readonly<LayoutFont>,
    sizePt: number,
  ) => number;
  readonly descenderAtSize: (
    font: Readonly<LayoutFont>,
    sizePt: number,
  ) => number;
  readonly underlineAtSize: (
    font: Readonly<LayoutFont>,
    sizePt: number,
  ) => UnderlineMetrics;
  ...
  readonly horizontalScaleFor: (font: Readonly<LayoutFont>) => number;
}
