...
//
// Deliberately not part of this package's public surface: it exists to give src/factor-styles.ts one tuple-identity recipe, and publishing it would invite a second caller to depend on the exact sort order as an API guarantee rather than as minting's internal determinism device.
