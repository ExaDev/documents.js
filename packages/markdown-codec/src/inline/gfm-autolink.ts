...
const VALID_PRECEDING_CHARACTERS: ReadonlySet<string> = new Set([
  "*",
  "_",
  "~",
  "(",
...
const OPAQUE_KINDS: ReadonlySet<string> = new Set([
  "link",
  "image",
  "codeSpan",
  "rawHtml",
...
function isValidDomain(domain: string): boolean {
  ...
  return segments
    .slice(-UNDERSCORE_FREE_TRAILING_SEGMENTS)
    .every((segment) => !segment.includes("_"));
}
