...
export const CANONICAL_PREFIX_BY_URI: ReadonlyMap<string, string> = new Map([
...
export const VALUE_ATTRIBUTE_LOCAL_NAMES = [
  "value-type",
  "value",
  "currency",
  "date-value",
...
export const CELL_ELEMENTS: ReadonlySet<string> = new Set([
  "table:table-cell",
  "table:covered-table-cell",
  "table:change-track-table-cell",
]);

export const TEXT_VALUE_ELEMENTS: ReadonlySet<string> = new Set([
  "text:variable-decl",
  "text:variable-set",
  "text:variable-input",
  "text:variable-get",
...
export const FRAME_SHAPES: ReadonlySet<string> = new Set([
  "draw:text-box",
  "draw:image",
  "draw:object",
  "draw:object-ole",
...
export const PACKAGE_HREF_ELEMENTS: ReadonlySet<string> = new Set([
  "draw:image",
  "draw:object",
  "draw:object-ole",
  "draw:applet",
...
export function carriesNoLength(attributeName: string): boolean {
...
export const OOO1_GRAPHIC_STYLE_FAMILY = "graphics";
export const ODF_GRAPHIC_STYLE_FAMILY = "graphic";
...
export const DOCUMENT_ROOT_ELEMENTS: ReadonlySet<string> = new Set([
  "office:document",
...
export const MOVED_TO_CHILD_ELEMENT: ReadonlyMap<
  string,
...
export function prefixRenames(root: XmlElement): Map<string, string> {
...
export const MANIFEST_PATH = "META-INF/manifest.xml";
