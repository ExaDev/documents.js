    ...
    [
      el("semantics", {}, [
        el("mrow", {}, [
          ...
          el("mrow", {}, [
            el("mrow", {}, [
              el("mo", { fence: "true", form: "prefix", stretchy: "false" }, [
                txt("("),
              ]),
              el("mrow", {}, [el("mi", {}, [txt("x")])]),
              el("mo", { fence: "true", form: "postfix", stretchy: "false" }, [
                txt(")"),
              ]),
            ]),
      ...
      "meta.xml": {
        ...
        nodes: [
          el("office:document-meta", {}, [
            el("office:meta", {}, [el("dc:title", {}, [txt("Pythagoras")])]),
          ]),
        ],
      },
    },
...
describe("readOdfFormulaMathMl", () => {
  ...
  it("returns empty metadata for a package with no meta.xml at all", () => {
    const pkg: Package = {
      parts: { "content.xml": { kind: "xml", nodes: [realFormulaMathRoot()] } },
    };
        ...
        "content.xml": {
          ...
          nodes: [
            el("math", { xmlns: "http://www.w3.org/1998/Math/MathML" }, [
              el("semantics", {}, [
                el("mi", {}, [txt("x")]),
                el("annotation", { encoding: "application/x-tex" }, [txt("x")]),
              ]),
            ]),
          ],
        },
...
describe("readOdfFormulaContent", () => {
  it("wraps a genuine LibreOffice-produced formula into a real ContentDocument of kind 'formula', carrying the identical mathml/starMath/metadata readOdfFormulaMathMl itself reads", () => {
    ...
    expect(document.formula.mathml).toEqual(
      readOdfFormulaMathMl(realFormulaPackage()).mathml,
    );
  });
...
describe("readOdfFormula: the package-native reader over the same fixture", () => {
  ...
  it("carries the ContentFormula leaf itself as the package's single child, with no styles table to mint", () => {
    const documentPackage = formulaPackage(
      readOdfFormula(realFormulaPackage()),
    );
    ...
    expect(documentPackage.children[0]?.starMath).toBe(
