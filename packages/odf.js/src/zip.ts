...
const FIXED_MTIME_YEAR = 1980;
const FIXED_MTIME_MONTH_INDEX = 5; // June, 0-indexed
const FIXED_MTIME_DAY = 15;
const FIXED_MTIME_HOUR_UTC = 12; // noon, for comfortable margin against every real IANA zone's offset
export const FIXED_ENTRY_MTIME = new Date(
  Date.UTC(
    FIXED_MTIME_YEAR,
    FIXED_MTIME_MONTH_INDEX,
    FIXED_MTIME_DAY,
    FIXED_MTIME_HOUR_UTC,
    0,
    0,
  ),
);
