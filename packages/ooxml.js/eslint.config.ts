...
export default tseslint.config(
  ...packageLintConfig({
    ...
    isomorphic: true,
    // Off: see PackageLintOptions.preferReadonlyParams in eslint.shared.ts for why -- this package's own OOXML readers/writers genuinely mutate a large number of array/object parameters in place. Tracked for burn-down.
