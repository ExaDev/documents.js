...
// A decoded docx Package -> the tree-form DocumentTree, via readDocxContent's own full style-cascade and construct walk. The DocxDocument fields outside `sections` (comments, footnotes, headers, footers, numbering) have no place in the tree and are dropped here; readDocxContent is the reader that returns them.
