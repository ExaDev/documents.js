...
describe("serialToIsoDate: the 1904 system", () => {
  ...
  it("sits exactly 1462 days ahead of the same calendar date in the 1900 system", () => {
    expect(serialToIsoDate(46234, false)).toBe(
      serialToIsoDate(46234 - 1462, true),
    );
  });
});
