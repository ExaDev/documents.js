...
function buildCommentedPackage(
  ...
  if (sheetRelationships.length > 0) {
    parts["xl/worksheets/_rels/sheet1.xml.rels"] = {
      kind: "xml",
      nodes: [el("Relationships", {}, sheetRelationships)],
    };
  }
...
function readCommentedCells(
  ...
  const result = readXlsxContent(
    buildCommentedPackage(sheetRelationships, extraParts),
  );
...
function findCell(
  cells: ReturnType<typeof readCommentedCells>,
  row: number,
  column: number,
) {
      ...
      ],
      {
        "xl/comments1.xml": {
          ...
          nodes: [
            el("comments", {}, [
              el("authors", {}, [
                el("author", {}, [txt("Joseph Mearman")]),
                el("author", {}, [txt("Sarah Smith")]),
              ]),
              el("commentList", {}, [
        ...
        "xl/comments1.xml": {
          ...
          nodes: [
            el("comments", {}, [
              ...
              el("commentList", {}, [
                el("comment", { ref: "A1", authorId: "5" }, [
                  el("text", {}, [txt("Plain note")]),
                ]),
              ]),
            ]),
          ],
      ...
      ],
      {
          ...
          nodes: [
            el("ThreadedComments", {}, [
              el(
                ...
                {
                  ref: "A1",
                  dT: "2026-08-17T09:30:00.000",
                  personId: "{4A6B5D62-8EC5-4C85-BC1F-7B9E2A25C111}",
                  id: "tc-root",
                },
                [el("text", {}, [txt("Thread root")])],
              ),
              el(
                "threadedComment",
                {
                  ref: "A1",
                  dT: "2026-08-17T10:00:00.000",
                  personId: "{4A6B5D62-8EC5-4C85-BC1F-7B9E2A25C222}",
                  id: "tc-reply-1",
                  parentId: "tc-root",
                },
                [el("text", {}, [txt("First reply")])],
              ),
              el(
                "threadedComment",
                {
                  ref: "A1",
                  dT: "2026-08-17T10:05:00.000",
                  personId: "{00000000-0000-0000-0000-000000000000}",
                  id: "tc-reply-2",
                  parentId: "tc-root",
                },
                [el("text", {}, [txt("Second reply")])],
              ),
            ]),
          ],
        },
        "xl/persons/person1.xml": {
          ...
          nodes: [
            el("personList", {}, [
              el("person", {
                displayName: "Joseph Mearman",
                id: "4a6b5d62-8ec5-4c85-bc1f-7b9e2a25c111",
                userId: "joseph@mearman.co.uk",
                providerId: "None",
              }),
              el("person", {
                displayName: "Sarah Smith",
                id: "4a6b5d62-8ec5-4c85-bc1f-7b9e2a25c222",
          ...
          nodes: [
            el("tc:ThreadedComments", {}, [
              el(
                ...
                {
                  ref: "A1",
                  dCreation: "1755425400000",
                  displayName: "Joseph Mearman",
                  dId: "root",
                },
                [el("tc:text", {}, [txt("Old-vocabulary root")])],
              ),
              el(
                "tc:threadedComment",
                {
                ...
                [el("tc:text", {}, [txt("Old-vocabulary reply")])],
              ),
            ]),
          ],
        },
        ...
        "xl/comments1.xml": {
          ...
          nodes: [
            el("comments", {}, [
              el("commentList", {}, [
                el("comment", { ref: "A1" }, [
                  el("text", {}, [txt("Legacy flattened copy of the thread")]),
                ]),
              ]),
            ]),
          ],
        ...
        "xl/threadedComments/threadedComment1.xml": {
          ...
          nodes: [
            el("ThreadedComments", {}, [
              el(
                "threadedComment",
                { ref: "A1", dT: "2026-08-17T09:30:00.000", id: "tc-root" },
                [el("text", {}, [txt("Thread root")])],
              ),
              el(
                "threadedComment",
...
describe("readXlsxContent: cell comments -- part resolution and tolerance boundaries (synthetic packages)", () => {
  it("resolves comment parts through the worksheet rels, never by part name: a canonical-looking xl/comments1.xml no rel points at stays unread", () => {
      ...
      ],
      {
        "xl/comments1.xml": {
          ...
          nodes: [
            el("comments", {}, [
              el("commentList", {}, [
                el("comment", { ref: "B2" }, [el("text", {}, [txt("Decoy")])]),
              ]),
            ]),
          ],
        },
    ...
    expect(
      cells.find((cell) => cell.row === 1 && cell.column === 1),
    ).toBeUndefined();
  });
    ...
    const cells = readCommentedCells(
      [
        el("Relationship", {
          Id: "rId1",
          Type: REL_COMMENTS,
          Target: "../comments-gone.xml",
        }),
        el("Relationship", {
          Id: "rId2",
          Type: REL_THREADED_COMMENTS,
          Target: "../threadedComments/not-xml",
        }),
      ],
