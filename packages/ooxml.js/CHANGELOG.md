...
* **deps:** bump archive-codec to ^1.2.0 in ooxml.js [skip ci] ([f074f61](https://github.com/ExaDev/documents.js/commit/f074f611f104382d3599157fd77798506532c1b4))
* **deps:** bump document-schema.js to ^5.1.0 in ooxml.js [skip ci] ([b1da39e](https://github.com/ExaDev/documents.js/commit/b1da39eb5128b87fd4cbe91773248c459757f23e))
...
* **docx:** type the embedded-presentation port's bytes as Uint8Array<ArrayBuffer> ([d9ebc73](https://github.com/ExaDev/documents.js/commit/d9ebc73d6d422bccb522ee2939e912284c060ecb))


### Features

* **docx:** serialise an embedded presentation through an injected port ([9b68a02](https://github.com/ExaDev/documents.js/commit/9b68a02fe19283b8953f69acf2ba0097e26ee8ff)), closes [#742](https://github.com/ExaDev/documents.js/issues/742)
...
* **ooxml:** pin zip entry mtimes so encodePackage is byte-deterministic ([b3cc755](https://github.com/ExaDev/documents.js/commit/b3cc7556f525689cad8500e422a1fbeb3fc7721a))
...
* **xlsx:** read table columns through the CT_Table tableColumns wrapper ([99316b9](https://github.com/ExaDev/documents.js/commit/99316b92be7ad2e19fed3094984cb402579fbf3a))


### Features

* **docx:** read header/footer parts as block flow with per-section references ([3a1ebfd](https://github.com/ExaDev/documents.js/commit/3a1ebfd09d431033eb2de813001902394b3a9378))
* **docx:** read the [#750](https://github.com/ExaDev/documents.js/issues/750) run-level construct rows plus w:ffData form fields ([6d1aad4](https://github.com/ExaDev/documents.js/commit/6d1aad459a06322375ad2ce9512a72b9f9ac0ec1))
* **docx:** read w:sectPr/w:type onto ContentSection.breakType and write it back ([b104715](https://github.com/ExaDev/documents.js/commit/b1047153cf48b0f3c7a7f1a71af53a11843445cf))
* **pptx:** read a:fld dynamic fields as field run constructs ([04d289c](https://github.com/ExaDev/documents.js/commit/04d289cf9b4c09e4dfb8c4e58ac3ced3a7883f38))
* **pptx:** read internal slide-jump links as link run constructs ([afd7b33](https://github.com/ExaDev/documents.js/commit/afd7b33d431058f3845a55da0e82f2044b50e8dc))
* **xlsx:** quarantine dataValidation and conditionalFormatting as anchor-cell residue ([e2d0ab4](https://github.com/ExaDev/documents.js/commit/e2d0ab4c3fdd8a2f858ae82c7d29488605096ed8))
* **xlsx:** read chart graphic frames as embedded chart objects ([31c2a19](https://github.com/ExaDev/documents.js/commit/31c2a19cf8181741aa827a942160a954634f7758))
* **xlsx:** read general defined names and table objects into the tree definitions table ([387ca28](https://github.com/ExaDev/documents.js/commit/387ca28b103858f10985854f506d8ec47dacbe89))
...
* emit a point bookmark extent's halves as a start-then-end pair, not an inverted one ([94e4ed2](https://github.com/ExaDev/documents.js/commit/94e4ed20dfbb207043d036680b4e4632a979a53f))
...
* **ooxml:** gate gallery-residue restoration on the richText controlType that mints it ([2d8f14f](https://github.com/ExaDev/documents.js/commit/2d8f14fb29e858c41d0a3a6881d612e527fb5beb))


### Features

* **ooxml:** carry a non-TOC docx SDT gallery in residue and restore it on write ([a9509bb](https://github.com/ExaDev/documents.js/commit/a9509bb6fe8b1445f3a8cf49c0763f5bb7294eeb))
* recover classic OLE compound-file .bin embedded payloads ([4c4ff1f](https://github.com/ExaDev/documents.js/commit/4c4ff1f564ec222a529ab8e2655a5ed2e1633895)), closes [#737](https://github.com/ExaDev/documents.js/issues/737)
* write recovered embedded OOXML objects back out as w:object OLE markup ([9d867b3](https://github.com/ExaDev/documents.js/commit/9d867b3339c6991c2597cd65c47ccf247989aa41))
